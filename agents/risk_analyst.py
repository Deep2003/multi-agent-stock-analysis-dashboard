...
def risk_node(state: AgentState):
    ...
    report = get_risk_audit_report(system_prompt, messages_payload, api_key=state.get("api_key"), selected_model=state.get("selected_model", "auto"), request_id=state.get("request_id"))
